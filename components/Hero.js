        ...
        <div className="relative z-10 bg-background-color pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
              ...
              <div className="flex flex-shrink-0 flex-grow items-center lg:flex-grow-0">
                <div className="flex w-full items-center justify-between md:w-auto">
                  <div className="-mr-2 flex items-center md:hidden">
                    <button
                      type="button"
                      className="inline-flex items-center justify-center rounded-md bg-background-color p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
                      aria-expanded="false"
                    >
                      <svg
                        className="h-6 w-6"
          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="mt-3 text-base text-secondary-color sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                ...
                {betterCollections.map((collection) => (
                  ...
                  >
                    <div className="mt-3 sm:mt-0 sm:ml-3">
                      <a className="flex w-full items-center justify-center rounded-md border border-transparent bg-secondary-color px-8 py-3 text-base font-medium text-background-color md:py-4 md:px-10 md:text-lg cursor-pointer hover:bg-accent-color">
